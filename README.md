...
| 💳 **Credit Card Fraud Detection** | A robust machine learning model and Streamlit web app that detect and visualize fraudulent transactions using Random Forest and anomaly detection. | [🔗 View](https://github.com/AkshayBhujbal1995/AI-Portfolio/tree/main/Showcase-Projects/Credit-Card-Fraud-Detection) |
